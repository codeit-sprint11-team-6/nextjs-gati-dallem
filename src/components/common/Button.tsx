    ...
    "disabled:cursor-not-allowed disabled:opacity-60",
  {
    variants: {
      variant: {
        ...
        bare:
          "bg-transparent text-white shadow-xs ",
        outline:
        ...
        ghost:
         ...
         gray:
          "bg-[var(--color-gray-50)] text-[var(--color-gray-500)] hover:bg-[var(--color-gray-50)] focus-visible:ring-[var(--color-gray-500)]",
        selected:
  ...
  (
    ...
    return (
      ...
      >
        ...
        {children && (
          <span className={cn(isIconOnly && isTextChild && "sr-only")}>
            {children}
          </span>
        )}
